...
<?php include('include/sidebar.php');?>				
	...
	<div class="module">
							<div class="module-head">
								<h3>Đơn Hàng Chưa Được Xử Lý</h3>
							</div>
...
?>										
										<tr>
											...
											<td><?php echo htmlentities($qty=$row['quantity']);?></td>
											<td><?php echo htmlentities($row['size']);?></td>
											<td><?php echo htmlentities($price=$row['productprice']);?></td>
											<?php $shippcharge=30; ?> 
											<td><?php echo htmlentities(($qty*$price)+$shippcharge);?></td>
