...
?>
						...
						<?php } ?>
						<div class="price">
							<?php echo htmlentities($row['pprice']);?>.000<sup>đ</sup>
					...
					<td class="col-md-2 close-btn">
						<a href="my-wishlist.php?del=<?php echo htmlentities($row['wid']);?>" onClick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này chứ ?')" class=""><i class="fa fa-times"></i></a>
					</td>
				</tr>
				<?php } } else{ ?>
				<tr>
