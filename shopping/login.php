...
echo "<script>alert('Bạn chưa đăng nhập, điều gì đó đang lỗi');</script>";
}
}
// Code for User login
...
<div class="col-md-6 col-sm-6 create-new-account">
	<h4 class="checkout-subtitle">Đăng Kí Tài Khoản Mới</h4>
	<p class="text title-tag-line">Tạo tài khoản mua sắm riêng bạn.</p>
...
<div class="form-group">
	...
	<div class="checkbox">
		 ...
		 - Nhanh chóng đạt hàng và giao hàng mọi nơi.
		</label>
		<label class="checkbox">
