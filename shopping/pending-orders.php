...
header('location:login.php');
	...
	if (isset($_GET['id'])) {
		...
		mysqli_query($con,"delete from orders  where userId='".$_SESSION['id']."' and orderStatus is null and id='".$_GET['id']."' ");
		;
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>Không Thấy Sản Phẩm Nào</h4></td>
</tr>
<?php } ?>
