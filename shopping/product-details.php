...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="admin/productimages/<?php echo htmlentities($rws['productImage1']);?>"  width="200" height="334" alt="">
							</div>
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									 <?php echo htmlentities($rws['productPrice']);?>.000<sup>đ</sup>
								</span>
...
?>
 ...
 <div class="single-product-gallery-item" id="slide1">
            ...
            <div class="single-product-gallery-item" id="slide3">
                <a data-lightbox="image-1" data-title="Gallery" href="admin/productimages/<?php echo htmlentities($row['productImage3']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['productImage3']);?>" />
                </a>
            </div>
            ...
            <div id="owl-single-product-thumbnails">
                <div class="item">
                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide1">
                        <img class="img-responsive"  alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['productImage1']);?>" />
                    </a>
                </div>
            ...
            <div class="item">
                ...
                <div class="item">
                    ...
                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="3" href="#slide3">
                        <img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['productImage3']);?>" height="200" />
                    </a>
                </div>
...
<?php } ?>
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price"> <?php echo htmlentities($row['productPrice']);?>.000<sup>đ</sup></span>
							...
							<div class="quantity-container info-container">
								...
								<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i>Thêm Vào Giỏ Hàng</a>
													<?php } else {?>
									<div class="action" style="color:red">Hêt Hàng</div>
								<?php } ?>
											</div>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Số Lượng :</b>  <?php echo htmlentities($rvw['quality']);?> Sao</div>
													<div class="text"><b>Giá Tiền  :</b>  <?php echo htmlentities($rvw['price']);?> Sao</div>
													<div class="text"><b>Chất Lượng :</b>  <?php echo htmlentities($rvw['value']);?> Sao</div>
											...
											<div class="review-table">
												<div class="table-responsive">
													<table class="table table-bordered">	
														...
														<tbody>
															<tr>
																<td class="cell-label">Số Lượng</td>
															...
															<tr>
																<td class="cell-label">Giá Tiền</td>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages
				/<?php echo htmlentities($rw['productImage1']);?>" width="150" height="240" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
				<?php echo htmlentities($rw['productPrice']);?>	.000<sup>đ</sup>		</span>
